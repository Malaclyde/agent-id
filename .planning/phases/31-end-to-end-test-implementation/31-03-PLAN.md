...
must_haves:
  truths:
    ...
    - "Asynchronous webhook processing is reliably verified"
...
<task type="auto">
  ...
  <action>
    ...
    Wait for and fill out the sandbox test card `4242 4242 ...` and submit. Ensure to explicitly use 'testuser-N' formatted emails/data during the checkout flow.
...
<task type="auto">
  ...
  <action>
    ...
    Setup: Register a regular Client locally using a test script/helper (unclaimed state) ensuring the use of 'testuser-N' formatted test data.
